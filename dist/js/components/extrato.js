...
function criarItemTransacao(transacao) {
    const isDebito = transacao.tipoTransacao === tipoTransacao.TRANSFERENCIA ||
...
export function renderizarExtrato(transacoes) {
    const registroTransacoes = document.querySelector('.registro-transacoes');
    if (!registroTransacoes)
        return;
